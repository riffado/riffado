...
- New optional env vars: `SMTP_MARKETING_FROM` (per-class From: override), `EMAIL_SEND_RATE_PER_SECOND` (campaign engine rate cap, default 5), `REACHER_API_URL` / `REACHER_API_KEY` (email-verification pre-flight; skipped entirely when key is unset).
