...
[Quick start](#quick-start) • [Documentation](https://mesynx-ai.com/docs) • [Discord](https://mesynx-ai.com/discord)

</div>

---

> **OpenPlaud is now Mesynx AI.** Same project, same code, same team, same license &mdash; renamed in May 2026 so the project isn't tied to one device vendor in its name. [Read the rebrand note &rarr;](https://mesynx-ai.com/rebrand)
...
Originally created by **Perier**. Maintained by the Mesynx AI community.
