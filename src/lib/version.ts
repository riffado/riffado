...
export const APP_RELEASE_URL = `https://github.com/mesynx-ai/mesynx-ai/releases/tag/${APP_VERSION_TAG}`;
...
export function releaseUrlFor(tag: string): string {
    return `https://github.com/mesynx-ai/mesynx-ai/releases/tag/${tag}`;
}
