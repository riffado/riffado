...
Mesynx AI has two separate export paths, deliberately. They serve
different jobs:
...
The archive is **plaintext**. Mesynx AI's at-rest encryption decrypts
...
- **Audio files in storage** are *not* encrypted by Mesynx AI's
