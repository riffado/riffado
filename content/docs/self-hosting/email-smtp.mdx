...
description: Configure an SMTP server so Mesynx AI can deliver email notifications.
---
...
Set these in the environment that runs Mesynx AI:
...
SMTP_FROM="Mesynx AI <noreply@example.com>"
```
