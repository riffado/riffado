...
Two ways to authenticate to Riffado's HTTP surface:
...
- Header: `X-Riffado-Signature: t=<unix>,v1=<hex hmac>`
...
at anything the Riffado container can reach (Docker-bridge service
...
## Trust boundaries Riffado does *not* own
...
- **Your AI provider.** Plaintext audio and plaintext transcripts go
  ...
  machine as your Riffado instance.
...
Riffado does not claim HIPAA, SOC2, or attorney-client privilege.
...
See [SECURITY.md](https://github.com/riffado/riffado/blob/main/SECURITY.md)
